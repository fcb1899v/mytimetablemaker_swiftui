...
extension Int {
    ...
    var countdownColor: Color {
        if (self % 2 == 0) {
            switch (self) {
            case 1000...9999: return Color.accentColor
            case 500...999: return Color.yellowColor
            case 0...499: return Color.redColor
            default: return Color.grayColor
            }
        } else {
...
extension Date {
    ...
    var weekFlag: Bool {
        ...
        return (weeknumber == 1 || weeknumber == 7) ? false: true
    }
